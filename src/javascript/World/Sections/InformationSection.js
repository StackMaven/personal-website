...
export default class InformationSection
{
    ...
    setLinks()
    {
        ...
        for(const _option of this.links.options)
        {
            ...
            item.labelMesh.position.x = item.x - 0.5 + this.links.labelWidth * 0.5 - this.links.halfExtents.x
